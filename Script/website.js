...
function search() {
    ...
    fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&appid=${apiKey}&units=metric`)
        ...
        .then(weatherData => {
            ...
            //     const days = new Date(weatherData.list.dt_txt).getDate();
            // };
        ///////////////////////////////////////////////////////////////////////////////////**
            ...
            weatherData.list.map = () => {
                for (i = 0; i < 3; i++)
                {
                    ...
                    day2Div.innerHTML += `
                                                ...
                                                <div class="day3Div">
                                                    <h4 id="day2">${weatherData.list[i + 9].dt_txt.slice(8, 11)}</h4>   
                                                    <div><img src="https://api.openweathermap.org/img/w/${weatherData.list[i].weather[0].icon}.png" alt="" id="weather_icon2"></div>
                                                    <h4 id="temp2">${weatherData.list[i+9].main.temp.toFixed(0)}°C</h4>     
                                                </div>
                                                <div class="day4Div">
                                                    <div>
                                                        <h4 id="day3">${weatherData.list[i + 17].dt_txt.slice(8, 11)}</h4>
                                                    </div>
                                                    <div><img src="https://api.openweathermap.org/img/w/${weatherData.list[i].weather[0].icon}.png" alt="" id="weather_icon3"></div>
                                                    <div>
                                                        <h4 id="temp3">${weatherData.list[i + 17].main.temp.toFixed(0)}°C</h4>
                                                    </div>
                                                </div>`    
                }
